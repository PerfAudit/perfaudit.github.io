...
- Grunt and Gulp tasks for Performance Optimization [http://yeoman.io/blog/performance-optimization.html](http://yeoman.io/blog/performance-optimization.html){:rel="nofollow"}{:target="_blank"}